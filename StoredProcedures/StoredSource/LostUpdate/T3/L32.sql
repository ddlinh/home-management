...
IF OBJECT_ID('L32_Fix') IS NOT NULL
	DROP PROCEDURE L32_Fix
GO

CREATE PROCEDURE L32_Fix(@Ma_Nha as int, @Ma_KH as int, @Ma_NV as int, @ngay AS DATE)
As
	Begin Transaction
