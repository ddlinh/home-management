...
IF OBJECT_ID('L31_Fix') IS NOT NULL
	DROP PROCEDURE L31_Fix
GO

CREATE PROCEDURE L31_Fix(@Ma_Nha as int, @Ma_KH as int, @Ma_NV as int, @ngay AS DATE)
As
