...
IF OBJECT_ID('L11_Fix') IS NOT NULL
	DROP PROCEDURE L11_Fix
GO



CREATE PROCEDURE L11_Fix(@Ma_Nha as int, @Ma_KH as int, @Ma_NV as int, @ngay AS DATE)
As
